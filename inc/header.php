            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active">  
                  <a class="nav-link" href="/opt/lampp/htdocs/feedback_app/index.php">
                    Home
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/opt/lampp/htdocs/feedback_app/feedback.php">
                    Feedback
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/opt/lampp/htdocs/feedback_app/about.php">
                    About
                  </a>
                </li>
              </ul>
